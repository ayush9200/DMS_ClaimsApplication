...
public class RawExcelDto {
	...
	public MedicalData _toConvertRawDataEntity(){
	    MedicalData entity = new MedicalData();
	   // java.sql.Date sqlDateDob = new java.sql.Date(dob.getTime());
	    //java.sql.Date sqlDateExpDate = new java.sql.Date(expiry.getTime());
	    entity.setPkid(this.pkid);
	    entity.setFileid(fileid);
	    entity.setFilerow(filerow);
	    ...
	    entity.setAdmitdate(admitdate);
	    entity.setDxcode(dxcode);
	    entity.setIcd10code(icd10code);
	    entity.setStarttime(starttime);
	    entity.setStoptime(stoptime);
	    entity.setBasicunits(basicunits);
	    entity.setTimeunits(timeunits);
	    entity.setQty(qty);
	    entity.setUnitfee(unitfee);
	    entity.setTotalfee(totalfee);
	    entity.setFacility(facility);
	    entity.setSlicode(slicode);
	    entity.setManreview(manreview);
